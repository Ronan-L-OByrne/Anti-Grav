        ...
        for (int i = 0; i < collisionOther.contacts.GetLength(0); i++)
        {
            ...
            else
            {
                if (myParent.expectedAngle == 0)
                {
                    ...
                    else if (collisionOther.contacts[i].point.y < myParent.playerBody.position.y - 0.385f)
                    {
                        //Debug.Log("BOTTOM");
                ...
                else
                {
                    ...
                    else if (collisionOther.contacts[i].point.x > myParent.playerBody.position.x + 0.385f)
                    {
                        //Debug.Log("BOTTOM");
